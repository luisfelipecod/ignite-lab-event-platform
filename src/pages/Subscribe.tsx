...
import MokupCode from '../assets/code-mockup.png';
        ...
        <div className = "min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
            <div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto">
                <div className="max-w-[640px]">
                    ...
                    <h1 className="mt-8 text-[2.5rem] leading-tight">Construa uma <strong className="text-blue-500">aplicação</strong> completa, do zero, com <strong className="text-blue-500">React</strong></h1>
                ...
                <div className="p-8 bg-gray-700 border-gray-500 rounded">
                    ...
                    <form onSubmit={handleSubscriber} className="flex flex-col gap-2">
                        <input
            ...
            <img src={MokupCode} className="mt-10" alt="" />
        </div>
    )
}